...
function Footer(): ReactNode {
  return (
    <footer className="px-4 divide-y bg-white text-primary mt-12">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          ...
          >
            ...
            <span className="self-center text-4xl font-black">FitHub</span>
          </Link>
        </div>
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-primary font-bold">
              Product
            </h3>
          ...
          <div className="space-y-3">
            <h3 className="uppercase text-primary font-bold">Developers</h3>
            <ul className="space-y-1">
              <li>
          ...
          <div className="space-y-3">
            <div className="uppercase text-primary font-bold">Social media</div>
